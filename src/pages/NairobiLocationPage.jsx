    ...
    <>
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <p className="page-subtitle">Organize group contributions in Nairobi with GroupFund. Perfect for Nairobi families, churches, schools, and groups.</p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="location-content">
            <div className="location-section">
              ...
              <p>Nairobi is Kenya's capital and largest city. GroupFund helps Nairobians organize group contributions effortlessly, whether for family celebrations, church groups, workplace teams, or friend circles.</p>
            ...
            <div className="location-section">
              ...
              <div className="features-list">
                <div className="feature-item"><h3>🏙️ Nairobi Families</h3><p>Organize group contributions for extended Nairobi families. Track contributions across Nairobi neighborhoods.</p></div>
                <div className="feature-item"><h3>⛪ Nairobi Churches</h3><p>Manage group contributions for Nairobi church members. Perfect for large Nairobi congregations.</p></div>
            ...
            <div className="location-section">
              ...
              <ul className="scenarios-list">
                ...
                <li><strong>Nairobi Church Communities:</strong> Manage group contributions for large Nairobi church congregations.</li>
            ...
            <div className="cta-box">
              <h2>Ready to Organize Group Contributions in Nairobi?</h2>
              <p>Join Nairobi groups using GroupFund to make contributions organized and stress-free.</p>
              <div className="cta-buttons">
                <Link to="/get-started" className="btn btn-primary btn-large">Start Your Nairobi Group</Link>
