...
export default function BabyShowerContributionsPage() {
  return (
    <>
      <SEO
        title="Baby Shower Group Contributions - Gifts, Parties & Baby Essentials | GroupFund"
        description="Organize group contributions for baby shower celebrations. Manage gift funds, party expenses, and baby essentials with ease for friends, family members, and coworkers."
        keywords="baby shower group contributions, baby shower gift fund, new baby contributions, baby essentials fund, workplace baby shower gifts, baby shower party expenses"
        canonical="https://www.groupfund.app/seasonal/baby-shower-contributions"
      />

      <section className="page-hero">
        <div className="container">
          <h1 className="page-title">Baby Shower Contributions</h1>
          <p className="page-subtitle">
            Organize group contributions for baby shower celebrations. Manage gift funds, party expenses, and baby essentials with ease for friends, family members, and coworkers celebrating new parents.
          </p>
        </div>
      </section>
      ...
      <section className="industry-page">
        <div className="container">
          <div className="industry-content">
            ...
            <div className="industry-section">
              <h2>Baby Shower Contribution Use Cases</h2>
            ...
            <div className="industry-section">
              <h2>Key Features for Baby Shower Contributions</h2>
              <div className="features-grid">
                ...
                <div className="feature-item">
                  ...
                  <p>Create separate groups for workplace, friends, and family contributions if needed, each with its own target and deadline.</p>
                </div>
              </div>
            </div>
            ...
            <div className="industry-section">
              <h2>Getting Started with Baby Shower Contributions</h2>
              <p>
            ...
            <div className="industry-cta">
              <h2>Start Organizing Your Baby Shower Contributions</h2>
              <p>Join friends, families, and workplaces using GroupFund to manage baby shower contributions and support new parents with thoughtful, well-organised giving.</p>
            ...
            <div className="related-resources">
              ...
              <div className="resources-grid">
                <Link to="/use-cases/baby-showers" className="resource-card">
                  <span className="resource-icon">🍼</span>
                  <h3>For Baby Showers</h3>
                  <p>Learn about GroupFund for baby showers and new baby celebrations</p>
                </Link>
