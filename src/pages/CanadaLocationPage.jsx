...
export default function CanadaLocationPage() {
  useEffect(() => {
    const localBusinessStructuredData = {
      ...
      "@type": "Organization",
      "name": "GroupFund",
      "description": "Organize group contributions in Canada with GroupFund. Perfect for Canadian families, churches, schools, and groups.",
      "url": "https://www.groupfund.app/locations/canada",
      ...
      <section className="page-hero">
        <div className="container">
          ...
          <p className="page-subtitle">
            Organize group contributions in Canada with GroupFund. Perfect for Canadian families, churches, schools, and groups.
          </p>
        </div>
      </section>
        ...
        <div className="container">
          <div className="location-content">
            <div className="location-section">
              ...
              <p>
                GroupFund is perfect for organizing group contributions in Canada. Whether you're managing contributions for your extended family, church members, school groups, or friend circles, GroupFund makes it simple and transparent.
              </p>
              <p>
            ...
            <div className="location-section">
              ...
              <div className="features-list">
                ...
                <div className="feature-item">
                  <h3>⛪ Church Groups</h3>
                  <p>Ideal for Canadian churches organizing group contributions for members. Manage large congregations efficiently.</p>
                </div>
                <div className="feature-item">
                  <h3>🏫 Schools & Universities</h3>
                  <p>Perfect for Canadian schools, universities, and student groups organizing group contributions.</p>
                </div>
                <div className="feature-item">
                  <h3>📱 Mobile-First</h3>
            ...
            <div className="location-section">
              ...
              <ul className="scenarios-list">
                <li><strong>Family Group Contributions:</strong> Organize contributions for extended Canadian families.</li>
                <li><strong>Church Member Contributions:</strong> Manage group contributions for church members in Canadian churches.</li>
            ...
            <div className="cta-box">
              <h2>Ready to Organize Group Contributions in Canada?</h2>
              <p>Join Canadian groups using GroupFund to make contributions organized and stress-free.</p>
              <div className="cta-buttons">
                <Link to="/get-started" className="btn btn-primary btn-large">Start Your Canadian Group</Link>
