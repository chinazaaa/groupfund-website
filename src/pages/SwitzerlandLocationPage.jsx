...
export default function SwitzerlandLocationPage() {
  useEffect(() => {
      ...
      <section className="location-detail-page">
        <div className="container">
          <div className="location-content">
            ...
            <div className="location-section">
              <h2>Key Features for Switzerland</h2>
              <div className="features-list">
                ...
                <div className="feature-item">
                  ...
                  <p>Perfect for Swiss bank transfers. Members can transfer directly to celebrants' bank accounts.</p>
                </div>
                <div className="feature-item">
                  <h3>👨‍👩‍👧‍👦 Perfect for Swiss Families</h3>
                  <p>Organize contributions for extended Swiss families. Track who has contributed across multiple family members.</p>
                </div>
                <div className="feature-item">
                  <h3>⛪ Church Groups</h3>
                ...
                <div className="feature-item">
                  <h3>📱 Mobile-First</h3>
                  <p>Native mobile app perfect for Switzerland's mobile culture. Access from anywhere, get push notifications.</p>
                </div>
              </div>
            </div>
            ...
            <div className="location-section">
              ...
              <ul className="scenarios-list">
                ...
                <li><strong>Friend Groups:</strong> Keep friend groups organized for birthday celebrations in Switzerland.</li>
              </ul>
            </div>

            <div className="location-section">
              <h2>How It Works in Switzerland</h2>
              <ol className="steps-list">
                <li><strong>Create Your Group:</strong> Set up a group with Swiss Franc (CHF) as the currency.</li>
                <li><strong>Set Contribution Amounts:</strong> Set amounts in CHF (e.g., CHF 25 or CHF 50 per person).</li>
            ...
            <div className="location-section">
              <h2>Why Swiss Groups Choose GroupFund</h2>
              <ul className="benefits-list">
                <li>Support for Swiss Franc (CHF)</li>
                <li>Perfect for Swiss bank transfers</li>
            ...
            <div className="cta-box">
              ...
              <div className="cta-buttons">
                <Link to="/get-started" className="btn btn-primary btn-large">Start Your Swiss Group</Link>
