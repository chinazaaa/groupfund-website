      ...
      <section className="location-detail-page">
        <div className="container">
          <div className="location-content">
            ...
            <div className="location-section">
              <h2>Key Features for Netherlands</h2>
              <div className="features-list">
                ...
                <div className="feature-item">
                  ...
                  <p>Perfect for Dutch bank transfers (SEPA). Members can transfer directly to celebrants' bank accounts.</p>
                </div>
                <div className="feature-item">
                  <h3>👨‍👩‍👧‍👦 Perfect for Dutch Families</h3>
                  <p>Organize contributions for extended Dutch families. Track who has contributed across multiple family members.</p>
                </div>
                <div className="feature-item">
                  <h3>⛪ Church Groups</h3>
                ...
                <div className="feature-item">
                  <h3>📱 Mobile-First</h3>
                  <p>Native mobile app perfect for Netherlands' mobile culture. Access from anywhere, get push notifications.</p>
                </div>
              </div>
            </div>
            ...
            <div className="location-section">
              ...
              <ul className="scenarios-list">
                ...
                <li><strong>Friend Groups:</strong> Keep friend groups organized for birthday celebrations in Netherlands.</li>
              </ul>
            </div>

            <div className="location-section">
              <h2>How It Works in Netherlands</h2>
            ...
            <div className="location-section">
              <h2>Why Dutch Groups Choose GroupFund</h2>
              <ul className="benefits-list">
                <li>Support for Euro (EUR)</li>
                <li>Perfect for Dutch bank transfers (SEPA)</li>
            ...
            <div className="cta-box">
              ...
              <div className="cta-buttons">
                <Link to="/get-started" className="btn btn-primary btn-large">Start Your Dutch Group</Link>
