...
export default function GermanyLocationPage() {
  useEffect(() => {
    const localBusinessStructuredData = {
      ...
      "url": "https://www.groupfund.app/locations/germany",
      ...
      <section className="location-detail-page">
        <div className="container">
          <div className="location-content">
            ...
            <div className="location-section">
              <h2>Key Features for Germany</h2>
              <div className="features-list">
                ...
                <div className="feature-item">
                  ...
                  <p>Perfect for German bank transfers (SEPA). Members can transfer directly to celebrants' bank accounts.</p>
                </div>
                <div className="feature-item">
                  <h3>👨‍👩‍👧‍👦 Perfect for German Families</h3>
                  <p>Organize contributions for extended German families. Track who has contributed across multiple family members.</p>
                </div>
                <div className="feature-item">
                  <h3>⛪ Church Groups</h3>
                ...
                <div className="feature-item">
                  <h3>📱 Mobile-First</h3>
                  <p>Native mobile app perfect for Germany's mobile culture. Access from anywhere, get push notifications.</p>
                </div>
              </div>
            </div>
            ...
            <div className="location-section">
              ...
              <ul className="scenarios-list">
                ...
                <li><strong>Friend Groups:</strong> Keep friend groups organized for birthday celebrations in Germany.</li>
              </ul>
            </div>

            <div className="location-section">
              <h2>How It Works in Germany</h2>
            ...
            <div className="location-section">
              <h2>Why German Groups Choose GroupFund</h2>
              <ul className="benefits-list">
                <li>Support for Euro (EUR)</li>
                <li>Perfect for German bank transfers (SEPA)</li>
            ...
            <div className="cta-box">
              ...
              <div className="cta-buttons">
                <Link to="/get-started" className="btn btn-primary btn-large">Start Your German Group</Link>
