          ...
          <div className="group-type-content">
            ...
            <div className="group-type-section">
              ...
              <div className="features-grid">
                ...
                <div className="feature-item">
                  ...
                  <p>
                    With auto-pay enabled (USD, EUR, GBP, CAD, or AUD), set up true recurring subscriptions with automatic monthly billing. Stripe automatically charges members each month without requiring any action - no manual payment needed each billing cycle. Perfect for matching your Prime billing cycle, whether monthly or annual.
                  </p>
                </div>
                <div className="feature-item">
            ...
            <div className="group-type-section">
              ...
              <ol className="how-it-works-list">
                ...
                <li><strong>For manual payments:</strong> Members receive automatic reminders before the billing date so they remember to pay, members mark their payment as &quot;Paid&quot; after sending money, and you (the Prime account holder) confirm each payment as it arrives</li>
