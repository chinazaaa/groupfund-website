...
export default function SaoPauloLocationPage() {
  useEffect(() => {
    const localBusinessStructuredData = {
      ...
      "@type": "Organization",
      "name": "GroupFund",
      "description": "Organize birthday contributions in São Paulo, Brazil with GroupFund. Perfect for São Paulo families, churches, schools, and groups.",
      "url": "https://groupfund.app/locations/sao-paulo",
