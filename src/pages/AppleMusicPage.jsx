          ...
          <div className="group-type-content">
            ...
            <div className="group-type-section">
              ...
              <div className="features-grid">
                ...
                <div className="feature-item">
                  ...
                  <p>
                    With auto-pay enabled (USD, EUR, GBP, CAD, or AUD), set up true recurring subscriptions with automatic monthly billing. Stripe automatically charges members each month without requiring any action - no manual payment needed each billing cycle. Perfect for matching your Apple Music billing cycle.
                  </p>
                </div>
                <div className="feature-item">
            ...
            <div className="group-type-section">
              ...
              <ol className="how-it-works-list">
                ...
                <li><strong>For manual payments:</strong> Members receive automatic reminders before the billing date so they pay on time, members mark their payment as "Paid" after sending money, and you (the family organizer/admin) confirm each payment as it arrives</li>
