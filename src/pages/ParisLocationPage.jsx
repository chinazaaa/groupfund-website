...
export default function ParisLocationPage() {
  useEffect(() => {
    const localBusinessStructuredData = {
      ...
      "@type": "Organization",
      "name": "GroupFund",
      "description": "Organize birthday contributions in Paris, France with GroupFund. Perfect for Paris families, churches, schools, and groups.",
      "url": "https://groupfund.app/locations/paris",
