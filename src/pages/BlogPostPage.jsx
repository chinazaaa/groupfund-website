...
const blogPostsData = {
  "how-group-discovery-helps-find-reliable-subscription-groups": {
    ...
    content: `
      <p>Finding a subscription group to join for Netflix, Spotify, or other shared services is easy. Finding a <strong>reliable</strong> subscription group where everyone actually pays on time? That's the real challenge. GroupFund's Group Discovery feature solves this problem by showing you exactly who will pay—and who won't—before you join.</p>

      <h2>The Problem: You Can't Know Who Will Pay</h2>
      <p>When you're looking for a subscription group to join, you face a fundamental problem: <strong>you can't know who will pay and who won't</strong>. Traditional methods leave you guessing:</p>
      <ul>
        <li><strong>Word of Mouth:</strong> Friends recommend groups, but you don't know the payment history</li>
        <li><strong>Social Media:</strong> People post looking for members, but there's no way to verify reliability</li>
        <li><strong>Random Joining:</strong> You join and hope for the best, often discovering payment issues later</li>
        <li><strong>No Transparency:</strong> You can't see if members consistently pay on time</li>
      </ul>
      <p>This uncertainty leads to frustration, missed payments, and groups falling apart. Group Discovery changes all of that.</p>

      <h2>How Group Discovery Works</h2>
      <p>Group Discovery is a search feature that lets you find public subscription groups. But it's not just a search—it's a <strong>reliability-first</strong> discovery system that shows you exactly what you need to know:</p>
      <ul>
        <li><strong>Search by Platform:</strong> Search for "Netflix" or "Spotify" to find groups for those services</li>
        <li><strong>Search by Group Name:</strong> Find groups by their specific name</li>
        <li><strong>See Health Metrics:</strong> Every result shows group health ratings and compliance rates</li>
        <li><strong>View Member Count:</strong> See how many members are in the group</li>
        <li><strong>Check Membership Status:</strong> See if you're already a member</li>
      </ul>
      <p>Groups are private by default—only subscription groups can be made public by their admins. This ensures that discovery is opt-in and controlled.</p>

      <h2>Understanding Health Metrics: Your Trust Indicator</h2>
      <p>The key to Group Discovery is <strong>health metrics</strong>. These metrics tell you exactly how reliable a group is:</p>
      
      <h3>Health Ratings</h3>
      <ul>
        <li><strong>Healthy:</strong> Excellent compliance—members consistently pay on time</li>
        <li><strong>Mostly Healthy:</strong> Good compliance—occasional late payments but generally reliable</li>
        <li><strong>Moderate:</strong> Some issues—some late payments or missed contributions</li>
        <li><strong>Unhealthy:</strong> Poor compliance—frequent late payments or missed contributions</li>
        <li><strong>New:</strong> Insufficient data—group is too new to have reliable metrics</li>
      </ul>

      <h3>How Health is Calculated</h3>
      <p>Health metrics are calculated based on:</p>
      <ul>
      ...
      <p>This data is automatically calculated from actual payment history, so you're seeing real reliability, not promises.</p>

      <h2>Why This Matters: The Real-World Impact</h2>
      <p>Before Group Discovery, joining a subscription group was a gamble. You might join a group where:</p>
      <ul>
        <li>Members frequently pay late, causing subscription interruptions</li>
        <li>Some members never pay, leaving others to cover their share</li>
        <li>The group falls apart after a few months due to payment issues</li>
        <li>You waste time and money on unreliable groups</li>
      </ul>
      <p>With Group Discovery, you can:</p>
      <ul>
        <li><strong>See Reliability Before Joining:</strong> Health metrics show you payment history upfront</li>
        <li><strong>Make Informed Decisions:</strong> Choose groups with "healthy" or "mostly healthy" ratings</li>
        <li><strong>Avoid Problem Groups:</strong> Skip groups with "unhealthy" ratings</li>
        <li><strong>Find Quality Groups:</strong> Discover groups where members consistently pay on time</li>
      </ul>

      <h2>How to Use Group Discovery</h2>
      <p>Using Group Discovery is simple:</p>
      
      <h3>1. Search for Groups</h3>
      <p>Search by platform name (like "Netflix" or "Spotify") or by group name. The search will show you all public subscription groups matching your query.</p>

      <h3>2. Review Health Metrics</h3>
      <p>Each search result shows:</p>
      <ul>
        <li>Group health rating (healthy, mostly healthy, moderate, unhealthy, or new)</li>
        <li>Member count</li>
      ...
      <h3>3. Make an Informed Decision</h3>
      <p>Based on the health metrics, decide if the group is reliable enough for you. Groups with "healthy" or "mostly healthy" ratings are generally safe bets.</p>

      <h3>4. Request to Join</h3>
      <p>Once you find a group you want to join, request to join. The admin will review your request (they can see your reliability score too), and you'll be notified when approved.</p>

      <h2>For Group Admins: Making Your Group Discoverable</h2>
      <p>If you're running a subscription group and want to make it discoverable:</p>
      <ul>
        <li><strong>Update Group Settings:</strong> Set your subscription group to public (isPublic: true)</li>
        <li><strong>Only Subscription Groups:</strong> Only subscription groups can be made public—birthday and general groups remain private</li>
        <li><strong>You Still Control Access:</strong> Even when public, you must approve all join requests</li>
        <li><strong>Opt-Out Anytime:</strong> You can make your group private again at any time</li>
      </ul>
      <p>Making your group discoverable helps you find reliable members who are actively looking for subscription groups to join.</p>

      <h2>The Competitive Advantage: Trust Through Transparency</h2>
      <p>Group Discovery gives GroupFund a unique advantage: <strong>it's the only subscription group platform where you can know who will pay before joining</strong>. This transparency builds trust and helps you find quality groups.</p>
      <p>Other platforms might let you search for groups, but they don't show you:</p>
      <ul>
        <li>Payment history</li>
        <li>On-time payment rates</li>
        <li>Group compliance metrics</li>
        <li>Health ratings based on actual data</li>
      </ul>
      <p>GroupFund does. This makes it the safest, most reliable way to find subscription groups.</p>

      <h2>Best Practices for Using Group Discovery</h2>
      <p>To get the most out of Group Discovery:</p>
      <ul>
        <li><strong>Prioritize Health Ratings:</strong> Look for groups with "healthy" or "mostly healthy" ratings</li>
        <li><strong>Check Member Count:</strong> Groups with more members often have more stable payment patterns</li>
        <li><strong>Review Contribution Amounts:</strong> Make sure the amount works for your budget</li>
        <li><strong>Be Patient:</strong> Wait for admin approval—they're reviewing your reliability too</li>
        <li><strong>Build Your Own Score:</strong> Pay on time in groups to build your reliability score, making you more attractive to quality groups</li>
      </ul>

      <h2>Real-World Example</h2>
      <p>Imagine you're looking for a Netflix subscription group. You search for "Netflix" and see three results:</p>
      <ul>
        <li><strong>Group A:</strong> Health: Healthy, 8 members, $5/month</li>
        <li><strong>Group B:</strong> Health: Mostly Healthy, 6 members, $5/month</li>
        <li><strong>Group C:</strong> Health: Unhealthy, 10 members, $4/month</li>
      </ul>
      <p>Even though Group C is cheaper, Group A or B would be better choices because they have better health ratings. The extra $1/month is worth the reliability and peace of mind.</p>

      <h2>Conclusion</h2>
      <p>Group Discovery solves the biggest problem with subscription groups: <strong>knowing who will pay</strong>. By showing health metrics based on actual payment history, it helps you find reliable groups and avoid problem groups. This transparency builds trust and makes subscription sharing safer and more reliable for everyone.</p>
      <p>Whether you're looking for a Netflix group, Spotify family plan, or any other shared subscription, Group Discovery helps you make informed decisions. No more guessing, no more unreliable groups—just transparent, data-driven discovery that helps you find quality subscription groups where members consistently pay on time.</p>
    `
  },
