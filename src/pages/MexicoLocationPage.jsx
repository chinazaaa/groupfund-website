...
export default function MexicoLocationPage() {
  useEffect(() => {
    const localBusinessStructuredData = {
      ...
      "url": "https://www.groupfund.app/locations/mexico",
          ...
          <div className="location-content">
            ...
            <div className="location-section">
              ...
              <ul className="scenarios-list">
                ...
                <li><strong>Friend Groups:</strong> Keep friend groups organized for birthday celebrations in Mexico.</li>
              </ul>
            </div>
            <div className="location-section">
              <h2>How It Works in Mexico</h2>
              <ol className="steps-list">
                <li><strong>Create Your Group:</strong> Set up a group with Mexican Peso (MXN) as the currency.</li>
                <li><strong>Set Contribution Amounts:</strong> Set amounts in MXN (e.g., $200 or $500 per person).</li>
                <li><strong>Add Member Birthdays:</strong> Add all group member birthdays to the calendar.</li>
                <li><strong>Track Contributions:</strong> Members mark payments as paid after transferring via SPEI.</li>
            ...
            <div className="location-section">
              <h2>Why Mexican Groups Choose GroupFund</h2>
              <ul className="benefits-list">
                <li>Support for Mexican Peso (MXN)</li>
                <li>Perfect for SPEI bank transfers</li>
            ...
            <div className="cta-box">
              ...
              <div className="cta-buttons">
                <Link to="/get-started" className="btn btn-primary btn-large">Start Your Mexico Group</Link>
