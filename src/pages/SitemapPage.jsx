...
{ path: "/locations/venezuela", label: "Venezuela" },
...
{ path: "/locations/israel", label: "Israel" },
...
{ path: "/locations/senegal", label: "Senegal" },
{ path: "/locations/saudi-arabia", label: "Saudi Arabia" },
...
{ path: "/locations/tel-aviv", label: "Tel Aviv" },
...
{ path: "/locations/belgrade", label: "Belgrade" },
        ...
        { path: "/locations/austria", label: "Austria" },
        { path: "/locations/bulgaria", label: "Bulgaria" },
        { path: "/locations/croatia", label: "Croatia" },
        { path: "/locations/czech-republic", label: "Czech Republic" },
        { path: "/locations/guinea-bissau", label: "Guinea-Bissau" },
        { path: "/locations/hungary", label: "Hungary" },
        { path: "/locations/iceland", label: "Iceland" },
        { path: "/locations/latvia", label: "Latvia" },
        { path: "/locations/liechtenstein", label: "Liechtenstein" },
        { path: "/locations/lithuania", label: "Lithuania" },
        { path: "/locations/luxembourg", label: "Luxembourg" },
{ path: "/locations/malta", label: "Malta" },
{ path: "/locations/macau", label: "Macau" },
{ path: "/locations/morocco", label: "Morocco" },
{ path: "/locations/romania", label: "Romania" },
        { path: "/locations/slovakia", label: "Slovakia" },
        { path: "/locations/slovenia", label: "Slovenia" },
        { path: "/locations/vienna", label: "Vienna" },
        { path: "/locations/sofia", label: "Sofia" },
        { path: "/locations/zagreb", label: "Zagreb" },
        { path: "/locations/prague", label: "Prague" },
        { path: "/locations/budapest", label: "Budapest" },
        { path: "/locations/reykjavik", label: "Reykjavik" },
        { path: "/locations/riga", label: "Riga" },
        { path: "/locations/vaduz", label: "Vaduz" },
        { path: "/locations/vilnius", label: "Vilnius" },
        { path: "/locations/luxembourg-city", label: "Luxembourg City" },
        { path: "/locations/valletta", label: "Valletta" },
{ path: "/locations/bucharest", label: "Bucharest" },
{ path: "/locations/caracas", label: "Caracas" },
{ path: "/locations/casablanca", label: "Casablanca" },
{ path: "/locations/macau-city", label: "Macau City" },
