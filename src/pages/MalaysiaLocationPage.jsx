...
export default function MalaysiaLocationPage() {
  useEffect(() => {
    const localBusinessStructuredData = {
      "@context": "https://schema.org",
      "@type": "Organization",
      "name": "GroupFund",
      "description": "Organize group contributions in Malaysia with GroupFund. Perfect for Malaysian families, communities, schools, and groups.",
      "url": "https://www.groupfund.app/locations/malaysia",
  ...
  return (
    <>
      <SEO
        title="GroupFund Malaysia - Group Contributions App for Malaysia"
        description="Organize group contributions in Malaysia with GroupFund. Perfect for Malaysian families, communities, schools, and groups. Support for MYR (Malaysian Ringgit). Free to start."
        keywords="group contributions Malaysia, Malaysia contribution app, groupfund Malaysia, group contributions app Malaysia, MYR contribution tracker, Malaysia group payments"
        canonical="https://www.groupfund.app/locations/malaysia"
      />
      ...
      <section className="location-detail-page">
        <div className="container">
          <div className="location-content">
            ...
            <div className="location-section">
              <h2>Key Features for Malaysia</h2>
              <div className="features-list">
                ...
                <div className="feature-item">
                  ...
                  <p>
                    Ideal for mosque, church, and temple communities and neighborhood groups coordinating shared support and regular contributions.
                  </p>
                </div>
                <div className="feature-item">
            ...
            <div className="location-section">
              <h2>Common Use Cases in Malaysia</h2>
              <ul className="scenarios-list">
                <li>
                  <strong>Family Group Contributions:</strong> Organize contributions for weddings, Hari Raya, Chinese New Year, Deepavali, and family events.
                </li>
                <li>
                ...
                <li>
                  <strong>Alumni Associations:</strong> Coordinate contributions among alumni from Malaysian schools and universities.
                </li>
                <li>
                  <strong>Workplace Groups:</strong> Organize office birthday, farewell, and support funds in Malaysian companies.
                </li>
                <li>
            ...
            <div className="location-section">
              <h2>Why Malaysian Groups Choose GroupFund</h2>
              <ul className="benefits-list">
                <li>Support for Malaysian Ringgit (MYR)</li>
            ...
            <div className="cta-box">
              <h2>Ready to Organize Group Contributions in Malaysia?</h2>
              <p>Join Malaysian groups using GroupFund to make contributions organized and stress-free.</p>
              <div className="cta-buttons">
                <Link to="/get-started" className="btn btn-primary btn-large">
                  Start Your Malaysia Group
                </Link>
