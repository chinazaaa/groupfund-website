...
export default function OfficePartyContributionsPage() {
  return (
    <>
      <SEO
        title="Office Party Group Contributions - Team Lunches, Events & Gifts | GroupFund"
        description="Organize group contributions for office celebrations. Manage party expenses, team lunches, and workplace events with ease for coworkers planning holiday parties, retirements, and team-building activities."
        keywords="office party contributions, workplace group collections, team lunch fund, retirement party collection, office celebration expenses, team-building event contributions"
        canonical="https://www.groupfund.app/seasonal/office-party-contributions"
      />

      <section className="page-hero">
        <div className="container">
          <h1 className="page-title">Office Party Contributions</h1>
          <p className="page-subtitle">
            Organize group contributions for office celebrations. Manage party expenses, team lunches, and workplace events with ease. Perfect for coworkers planning holiday parties, retirement celebrations, or team-building activities.
          </p>
        </div>
      </section>
      ...
      <section className="industry-page">
        <div className="container">
          <div className="industry-content">
            ...
            <div className="industry-section">
              <h2>Office Party Contribution Use Cases</h2>
            ...
            <div className="industry-section">
              <h2>Key Features for Office Party Contributions</h2>
            ...
            <div className="industry-section">
              <h2>Getting Started with Office Party Contributions</h2>
              <p>
            ...
            <div className="industry-cta">
              <h2>Start Organizing Your Office Party Contributions</h2>
              <p>Join teams and workplaces using GroupFund to manage office party contributions, making celebrations easier to plan and more inclusive for everyone.</p>
            ...
            <div className="related-resources">
              ...
              <div className="resources-grid">
                <Link to="/use-cases/office-parties" className="resource-card">
                  <span className="resource-icon">🏢</span>
                  <h3>For Office Parties</h3>
                  <p>Learn about GroupFund for workplace celebrations and events</p>
                </Link>
